...
- Keyboard navigation for the file browser: Arrow keys to move between entries (spatial navigation in grid view, sequential in list view), Enter to open the first selected directory or file, Backspace to navigate back. Works in both grid and list layout views;
