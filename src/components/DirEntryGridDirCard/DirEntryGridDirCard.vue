...
<template>
  ...
  >
    ...
    >
      <div class="dir-entry-grid-dir-card__preview">
        <Icon
          icon="mdi:folder-outline"
          width="28"
        />
      </div>
      <div class="dir-entry-grid-dir-card__content">
        <div class="dir-entry-grid-dir-card__content-title">
          {{ props.dirEntry.name }}
        </div>
        <div class="dir-entry-grid-dir-card__content-description">
...
.dir-entry-grid-dir-card__preview {
  display: flex;
  width: 100%;
  height: 100%;
  align-items: center;
...
.dir-entry-grid-dir-card__content {
  display: flex;
  overflow: hidden;
...
.dir-entry-grid-dir-card__content-title {
  overflow: hidden;
  max-width: 90%;
  color: var(--color-darker-2);
  font-size: 14px;
...
.dir-entry-grid-dir-card__content-description {
  overflow: hidden;
  max-width: 90%;
