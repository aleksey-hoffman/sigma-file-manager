...
<template>
  ...
  >
    ...
    >
      <div class="dir-entry-grid-file__overlay" />
      <div class="dir-entry-grid-file__overlay-2" />
      <div class="dir-entry-grid-file__overlay-3" />
      <div class="dir-entry-grid-file__preview-blur" />
      <div class="dir-entry-grid-file__preview" />
      <div class="dir-entry-grid-file__icon">
        <Icon
          icon="ph:file-text-light"
        />
      </div>
      <div class="dir-entry-grid-file__content">
        <div class="dir-entry-grid-file__bottom-container">
          <div class="dir-entry-grid-file__bottom-container-title">
            {{ props.dirEntry.name }}
          </div>
          <div class="dir-entry-grid-file__bottom-container-description">
...
.dir-entry-grid-file__preview-blur {
  --image-blur-size: 8px;
...
.dir-entry-grid-file__preview-blur-image {
  width: 100%;
  height: 100%;
  filter:
    brightness(0.9)
    contrast(1.1)
    invert(0.1)
    saturate(2); /* even out the colors  */
}

.dir-entry-grid-file__preview-image {
  width: 100%;
  height: 100%;
  object-fit: cover;
  transform: translate3d(0, 0, 0); /* enable GPU acceleration */
...
.dir-entry-grid-file__bottom-container {
  position: absolute;
  z-index: 3;
  bottom: 0;
  left: 0;
...
.dir-entry-grid-file__bottom-container-title {
  overflow: hidden;
  max-width: 90%;
...
.dir-entry-grid-file__bottom-container-description {
  overflow: hidden;
  max-width: 90%;
  color: var(--color);
  font-size: 14px;
...
.dir-entry-grid-file[media-type="image"]
  .dir-entry-grid-file__overlay {
    position: absolute;
    z-index: 3;
    bottom: -1px;
    left: 0;
