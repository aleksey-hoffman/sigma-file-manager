...
import {DirEntryGridDirCard} from '@/components/DirEntryGridDirCard';
import {DirEntryGridFileCard} from '@/components/DirEntryGridFileCard';
...
const formattedDirEntriesGrid = computed<VirtualEntry[]>(() => {
  ...
  results.forEach(virtualEntry => {
    if (virtualEntry.type === 'dirs') {
      virtualEntry.component = 'DirEntryGridDirCard';
    } else if (virtualEntry.type === 'files') {
      virtualEntry.component = 'DirEntryGridFileCard';
    }
  });
  return results;
});
