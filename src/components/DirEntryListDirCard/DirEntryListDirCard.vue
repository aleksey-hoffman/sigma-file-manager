...
<template>
  ...
  >
    ...
    >
      ...
      <DynamicText
        class="dir-entry-card--list-dir__content"
        :height="props.height"
      >
        <div class="dir-entry-card--list-dir__content-block">
          {{ props.dirEntry.name }}
        </div>
      </DynamicText>
    </div>
...
.dir-entry-card--list-dir__preview {
  display: flex;
  width: 100%;
  height: 100%;
  align-items: center;
...
.dir-entry-card--list-dir__content {
  overflow: auto;
}

.dir-entry-card--list-dir__content-block {
  display: -webkit-box;
  overflow: hidden;
