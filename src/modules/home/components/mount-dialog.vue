...
<template>
  ...
  >
    <DialogContent class="mount-dialog">
      ...
      <div class="mount-dialog__tabs">
        <button
          type="button"
          class="mount-dialog__tab"
          :class="{ 'mount-dialog__tab--active': activeTab === 'devices' }"
          @click="activeTab = 'devices'; scanDevices()"
        >
        ...
        <button
          type="button"
          class="mount-dialog__tab"
          :class="{ 'mount-dialog__tab--active': activeTab === 'network' }"
...
.mount-dialog__tab:hover {
  color: hsl(var(--foreground));
}

.mount-dialog__tab--active {
