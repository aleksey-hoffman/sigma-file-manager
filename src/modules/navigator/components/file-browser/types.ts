...
export type ContextMenuAction = 'rename' | 'copy' | 'cut' | 'paste' | 'delete' | 'delete-permanently' | 'open-with' | 'quick-view' | 'print' | 'share' | 'open-in-new-tab' | 'toggle-favorite' | 'edit-tags' | 'copy-path' | 'create-file' | 'create-directory';
