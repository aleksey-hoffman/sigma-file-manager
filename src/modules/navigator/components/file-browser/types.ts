...
export type ContextMenuAction = 'rename' | 'copy' | 'cut' | 'paste' | 'delete' | 'delete-permanently' | 'open-with' | 'quick-view' | 'share' | 'open-in-new-tab' | 'toggle-favorite' | 'edit-tags' | 'copy-path';
