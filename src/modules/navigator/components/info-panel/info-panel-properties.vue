...
.info-panel-properties--stacked .info-panel-properties__item {
  display: flex;
  flex-direction: column;
  gap: 2px;
}
...
.info-panel-properties--stacked .info-panel-properties__title {
  line-height: inherit;
}
...
.info-panel-properties--stacked .info-panel-properties__item--size {
  align-items: stretch;
}
