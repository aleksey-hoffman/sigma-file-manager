...
const data = {
  ...
  tooltip_button_shortcut: 'Scorciatoia',
  tooltip_button_ui_zoom_decrease_title: 'Diminuisci il livello di zoom',
  tooltip_button_ui_zoom_increase_title: 'Aumenta il livello di zoom',
  tooltip_button_ui_zoom_reset_title: 'Ripristina il livello di zoom',
  tooltip_button_full_screen_title: 'Schermo intero',
  tooltip_text_to_copy: 'Copiare',
  text_drive: 'Disco',
  text_drives: 'Dischi',
  text_global_search_title: 'Ricerca globale',
  text_system_directories: 'Directory di sistema',
  text_directory: 'directory',
  text_file: 'file',
  text_file_symlink: 'file-symlink',
  text_directory_symlink: 'directory-symlink',
  text_item: 'elemento',
  text_item_plural: 'elementi',
  text_size: 'Dimensione',
  text_file_size: 'File size',
  text_directory_size: 'Dimensione della directory',
  text_get_size: 'Ottieni dimensioni',
  text_path: 'Percorso',
  text_real_path: 'Collega percorso di destinazione',
  text_created: 'Creato',
